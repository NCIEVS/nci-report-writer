                                ...
                                <tr>
                                  <td valign="top">
                                    <table summary="" cellpadding="0" cellspacing="0" border="0" width="100%" class="sidebarSection">
                                      ...
                                      <tr>
                                        <td class="sidebarContent">NCI EVS Report Writer to be released on March 23, 2009.<br> </td>
                                      </tr>
                                    </table>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  <td valign="top">
                                    ...
                                    <tr>
                                      <td class="sidebarContent" valign="top">NCI EVS Report Writer is the first application to utilize the caCORE SDK's Writable APIs. </td>
                                    </tr>
                                    </table>
                                  </td>
                                </tr>
